...
in
{
  options.services.memos = {
    ...
    package = lib.mkOption {
      ...
      description = "The Memos package to use.";
    };
    ...
    port = lib.mkOption {
      type = lib.types.port;
      default = 5230;
      description = "The port on which Memos will listen.";
    };
      ...
      defaultText = lib.literalExpression ''
        {
          MEMOS_MODE = "prod";
          MEMOS_ADDR = "127.0.0.1";
          MEMOS_PORT = toString config.services.memos.port;
          MEMOS_DATA = config.services.memos.dataDir;
          MEMOS_DRIVER = "sqlite";
          MEMOS_INSTANCE_URL = "http://localhost:\${toString config.services.memos.port}";
        }
      '';
    };
